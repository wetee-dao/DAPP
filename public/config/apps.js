...
const teeApps = [
    {
        ...
        "docker": {
            ...
            "port": [{ "key": "Tcp", "value": 3000 }, { "key": "Tcp", "value": 22 }],
            "disk": [
                { "key": "/data", "value": 1 }
            ]
        }
        ...
        "docker": {
            ...
            "env": [
                { "key": "ser_port", "value": "{{.ser_0_nodeport}}" },
                { "key": "tcp_port", "value": "{{.ser_1_nodeport}}" },
                { "key": "udp_port", "value": "{{.ser_2_nodeport}}" }
            ]
        }
    }, {
        "name": "LiveKitMeet UI",
        ...
        "docker": {
            "image": "mysql:8.0",
            "port": [{ "key": "Tcp", "value": 3306 }],
            "disk": [
                { "key": "/var/lib/mysql", "value": 1 }
            ],
            "env": [
        ...
        "docker": {
            ...
            "env": [
                { "key": "MARIADB_ROOT_PASSWORD", "value": "123456" }
            ]
        }
    }, {
        "name": "Redis",
        ...
        "docker": {
            "image": "redis:7.2.4",
            "port": [{ "key": "Tcp", "value": 6379 }]
        }
    }, {
        "name": "Stable Diffusion",
        "create_type": "gpu",
        "runtime": "CVM",
        "icon": "https://wetee.app/static/web3/img/apps/Stable_Diffusion.png",
        ...
        "docker": {
            ...
            "port": [{ "key": "Tcp", "value": 7860 }],
            "env": [
                { "key": "COMMANDLINE_ARGS", "value": " --no-half-vae --share --xformers " }
            ],
            "meta": { "ai-model": "sd" }
        }
    }, {
        ...
        "create_type": "gpu",
        "runtime": "CVM",
        "icon": "https://wetee.app/static/web3/img/apps/Ollama.png",
        ...
        "docker": {
            ...
            "port": [{ "key": "Tcp", "value": 8080 }],
            "env": [
            ],
            "meta": { "ai-model": "ollama" }
        }
    }, {
        "name": "Golang",
        "create_type": "service",
        "runtime": "SGX",
        "icon": "https://wetee.app/static/web3/img/apps/golang.png",
        ...
        "create_type": "task",
        "runtime": "SGX",
        "icon": "https://wetee.app/static/web3/img/apps/Rust.png",
        ...
        "docker": { "image": "wetee/grust:2024-03-09-08-49" }
    }, {
        "name": "Python",
        "create_type": "task",
        "runtime": "SGX",
        "icon": "https://wetee.app/static/web3/img/apps/Python.png",
        ...
        "docker": { "image": "wetee/gpython:2024-03-09-09-21" }
    }, {
        "name": "Nginx/C++ - SGX",
        "create_type": "service",
        "runtime": "SGX",
        "icon": "https://wetee.app/static/web3/img/apps/Nginx.png",
        ...
        "create_type": "task",
        "runtime": "SGX",
        "icon": "https://wetee.app/static/web3/img/apps/Node.png",
        ...
        "docker": { "image": "wetee/gnodejs:2024-03-09-07-53" }
    }, {
        "name": "Twentycrm",
        "create_type": "service",
        "runtime": "CVM",
        "icon": "https://docs.twenty.com/img/logo-square-dark.svg",
        ...
        "docker": {
            ...
            "port": [{ "key": "Tcp", "value": 0 }],
            "env": [
                { "key": "PORT", "value": "{{.ser_0_nodeport}}" },
                { "key": "PG_DATABASE_URL", "value": "postgres://postgres:123456@127.0.0.1:5432/postgres" },
                { "key": "SERVER_URL", "value": "http://xiaobai.asyou.me:{{.ser_0_nodeport}}" },
                { "key": "FRONT_BASE_URL", "value": "http://0.0.0.0:{{.ser_0_nodeport}}" },
                { "key": "SIGN_IN_PREFILLED", "value": "true" },
                { "key": "STORAGE_TYPE", "value": "local" },
                { "key": "ACCESS_TOKEN_SECRET", "value": "123456" },
                { "key": "LOGIN_TOKEN_SECRET", "value": "123456" },
                { "key": "REFRESH_TOKEN_SECRET", "value": "123456" },
                { "key": "FILE_TOKEN_SECRET", "value": "123456" },
                { "key": "POSTGRES_PASSWORD", "value": "123456" },
            ],
        }
    }, {
        "name": "Postgres",
    ...
    },
    {
        ...
        "create_type": "service",
        "runtime": "CVM",
        "icon": "https://wetee.app/static/web3/img/apps/substrate.png",
    ...
    },
    {
        ...
        "create_type": "service",
        "runtime": "CVM",
        "icon": "https://wetee.app/static/web3/img/apps/alogo.svg",
    ...
    },
    {
        ...
        "create_type": "service",
        "runtime": "CVM",
        "icon": "https://evershop.io/img/logo.png",
